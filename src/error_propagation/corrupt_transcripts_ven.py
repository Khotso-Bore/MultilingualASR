...
Usage:
    python src/error_propagation/corrupt_transcripts_ven.py --input dataset/processed/nchlt_ven/test.csv \
        --target-wer 0.3 --mode mixed --seed 42 --output /tmp/corrupted_30.csv
    python src/error_propagation/corrupt_transcripts_ven.py ... --mode substitution   # ablation
    python src/error_propagation/corrupt_transcripts_ven.py ... --error-model results/zero_shot/large-v3_nchlt_test.csv
"""
